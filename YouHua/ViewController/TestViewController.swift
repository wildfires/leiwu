...
class TestViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var citysTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        citysTableView.registerClass(MineViewCell.self, forCellReuseIdentifier: "cell")
        makeCityToGroup()
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell: HomeViewCell = tableView.dequeueReusableCellWithIdentifier("cell") as! HomeViewCell
